...
const ChatInput: React.FC<ChatInputProps> = ({ onSend, isLoading }) => {
  ...
  return (
    <div className="px-6 pb-5 pt-4 bg-gradient-to-t from-c-base to-transparent transition-colors duration-300">
      {/* Input wrapper */}
      <div
        className={`
          flex items-end gap-2.5 bg-c-elevated border-[1.5px] border-[var(--c-border)]
          rounded-[28px] pl-[18px] pr-2.5 py-2.5 transition-all duration-200
          max-w-[820px] mx-auto
      ...
      >
        ...
        <button
          ...
          className={`
            ...
            ${canSend
              ? 'bg-gradient-to-br from-[#8a5cf6] to-[#6d28d9] text-white shadow-send hover:scale-110 hover:shadow-send-hover cursor-pointer'
